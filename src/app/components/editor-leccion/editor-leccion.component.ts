  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="space-y-4 min-h-[300px]">
        <div *ngFor="let bloque of bloques; let i = index" class="group relative bg-white/[0.02] hover:bg-white/[0.04] p-4 rounded-2xl border border-white/5 transition-all">
